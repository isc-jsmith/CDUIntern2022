...
const DrawerRoutes=()=>{
    return (
            <Drawer.Navigator initialRouteName='HomeScreen' screenOptions={{ headerShown: false }} drawerContent={props => <CustomDrawer {...props} />}
                screenOptions={{
                    headerShown: false,
                ...
                <Drawer.Screen name="Change Password" component={ChangePasswordScreen} options={{
                    drawerIcon: ({ color }) => (
                        <Ionicons name="lock-closed" size={22} color={color} />
                    )
                }} />
                <Drawer.Screen name="Set Alerts" component={AlertSettingScreen} options={{
                    drawerIcon: ({ color }) => (
                        <Ionicons name="timer-outline" size={22} color={color} />
                    )
                }} />
                <Drawer.Screen name="App Details" component={AppDetailScreen} options={{
                    drawerIcon: ({ color }) => (
